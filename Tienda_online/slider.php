                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-7 col-12 order-md-1 order-2">
                            <h4>Smartwatch<br></h4>
                            <p>Descripción</p>
                            <a href="productos.php">Házte con ellos</a>
                        </div>
        ...
        <div class="carousel-item">
            <div class="mask flex-center">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-7 col-12 order-md-1 order-2">
                            <h4>Pack Xeon X99 2678 v3<br></h4>
                            <p>Descripción</p>
                            <a href="productos.php">Házte con él</a>
                        </div>
                        <div class="col-md-5 col-12 order-md-2 order-1"><img src="imagenes/productos/x99.jpg" class="mx-auto" alt="slide"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="carousel-item">
            <div class="mask flex-center">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-7 col-12 order-md-1 order-2">
                            <h4>Auriculares TWS iPro i3<br></h4>
                            <p>Descripción</p>
                            <a href="productos.php">Házte con ellos</a>
                        </div>
                        <div class="col-md-5 col-12 order-md-2 order-1"><img src="imagenes/productos/pro3.jpg" class="mx-auto" alt="slide"></div>
                    </div>
                </div>
            </div>
        </div>
