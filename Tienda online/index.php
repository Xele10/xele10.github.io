            ...
            <div class="product-grid2">
                <div class="product-image2">
                    ...
                    <ul class="social">
                        ...
                        <li><a href="carrito.php?id_producto=<?= $fila["id_producto"] ?>" data-tip="Añadir a Deseos"><i class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="carrito.php?id_producto=<?= $fila["id_producto"] ?>" data-tip="Añadir al carrito"><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                    <a class="add-to-cart" href="carrito.php?id_producto=<?= $fila["id_producto"] ?>">Añadir al carrito</a>
                </div>
