            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="contact-form-content">
                        ...
                        <form method="POST" action="procesarContacto.php" class="contact-form" novalidate="novalidate">
                            <input type="text" name="usuario" id="usuario" placeholder="Nombre y apellidos" value=""required>
                            <input type="text" name="email" id="email" placeholder="Email" required>
                            <textarea name="texto" id="texto" placeholder="¿Qué pregunta desea hacernos?" required></textarea>
